...
o incluso ser parte de otras clases. La composición es uno de los conceptos fundamentales de la POO y tiene lugar cuando una clase (“que tiene”) hace referencia a uno o más objetos de otras clases 
(“que son parte”) del programa, como una variable. Entonces, al usar el nombre de una clase o al crear un objeto, accedemos a los miembros de una clase dentro de otra.

Mediante este mecanismo solo se puede utilizar la clase “que es parte de” la otra, no se puede modificar ni extender la funcionalidad de la primera clase generada.
De modo que cuando se necesita usar otra clase sin ninguna modificación, se recomienda aplicarlo. 
...
película1=Película("Bleu","2hs.",1993) #Instancio un objeto de la clase película

c=Catálogo([película1]) #Instancio la lista de la clase catálogo con el objeto definido en una variable simple.
