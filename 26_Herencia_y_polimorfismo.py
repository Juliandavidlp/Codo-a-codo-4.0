...
"""
Este es un ejemplo muy simple del concepto de herencia. El objeto hijo hereda los métodos y atributos
...
"""
La definición de la subclase Alumno_de_Codo_a_codo incluye en su declaración el argumento “Persona”, que hace referencia a la superclase. 
En su constructor,utiliza el método constructor de la superclase y agrega un nuevo atributo de clase, “curso”, 
...
"""
En este punto, tengo la superclase y la subclase definidas. Puedo instanciar objetos de la superclase. Y ahora también 
puedo hacer lo mismo con la subclase:

Damián=Alumno_de_Codo_a_codo(1,"Damián","Dorao",45494842,"Full-Stack en Python de Codo a Codo")
print(Damián)

Pero al imprimir el objeto Damián, estoy usando el método __str__ de la superclase Persona, que fue heredado por la subclase Alumno_de_Codo_a_codo,
motivo por el que el curso al que pertenece Damián no se muestra por pantalla. Y para solucionarlo tuve que agregarle a la subclase un método 
__str__ que reemplaze al método heredado de la superclase.
"""
# Programa principal:
Damián=Alumno_de_Codo_a_codo(1,"Damián","Dorao",45494842,"Full-Stack en Python de Codo a Codo")
print(Damián) 